...
# checkov:skip=CKV_SECRET_6: Used to encrypt the AWS SSO configuration file, will be addressed as per the above TODO.
...
# System packages required to build common R packages (e.g. arrow, curl, systemfonts, ragg, gert, igraph, V8, openssl, clipr, xml2, knitr/rmarkdown)
apt-get install --yes \
  "r-base=${R_VERSION}" \
